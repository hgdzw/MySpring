...
public class ApiTest {
    ...
    public void testFactory10() {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:springScan.xml");
    ...
    /**
     *
     * 带有@Value 和 @Autoware注解的
     */
    @Test
    public void testFactory11() {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:springScanValueAutoware.xml");
        IPeopleService peopleService = applicationContext.getBean("peopleAutoService", IPeopleService.class);
        System.out.println(peopleService.queryUserInfo());
    }
